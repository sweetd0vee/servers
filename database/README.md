...
Проект использует PostgreSQL в качестве основного хранилища данных для метрик серверов. Интеграция реализована через SQLAlchemy ORM для единообразной работы с базой данных.
